...
import { OMNIDEF } from './reviewAndSubmitSalesPersonSalesPersonEnglish_def.js';
import tmpl from './reviewAndSubmitSalesPersonSalesPersonEnglish.html';
import tmpl_nds from './reviewAndSubmitSalesPersonSalesPersonEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class reviewAndSubmitSalesPersonSalesPersonEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

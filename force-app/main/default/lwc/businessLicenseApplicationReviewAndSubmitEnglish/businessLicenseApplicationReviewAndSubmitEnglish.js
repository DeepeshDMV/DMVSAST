...
import { OMNIDEF } from './businessLicenseApplicationReviewAndSubmitEnglish_def.js';
import tmpl from './businessLicenseApplicationReviewAndSubmitEnglish.html';
import tmpl_nds from './businessLicenseApplicationReviewAndSubmitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationReviewAndSubmitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

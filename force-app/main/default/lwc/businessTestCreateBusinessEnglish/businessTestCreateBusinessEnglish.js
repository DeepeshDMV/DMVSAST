...
import { OMNIDEF } from './businessTestCreateBusinessEnglish_def.js';
import tmpl from './businessTestCreateBusinessEnglish.html';
import tmpl_nds from './businessTestCreateBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessTestCreateBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

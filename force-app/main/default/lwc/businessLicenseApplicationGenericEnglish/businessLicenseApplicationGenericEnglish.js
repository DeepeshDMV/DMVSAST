...
import { OMNIDEF } from './businessLicenseApplicationGenericEnglish_def.js';
import tmpl from './businessLicenseApplicationGenericEnglish.html';
import tmpl_nds from './businessLicenseApplicationGenericEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationGenericEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

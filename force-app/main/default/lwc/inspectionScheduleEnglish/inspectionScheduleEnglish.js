...
import { OMNIDEF } from './inspectionScheduleEnglish_def.js';
import tmpl from './inspectionScheduleEnglish.html';
import tmpl_nds from './inspectionScheduleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inspectionScheduleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

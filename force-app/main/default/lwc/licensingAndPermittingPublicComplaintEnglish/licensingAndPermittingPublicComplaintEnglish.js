...
import { OMNIDEF } from './licensingAndPermittingPublicComplaintEnglish_def.js';
import tmpl from './licensingAndPermittingPublicComplaintEnglish.html';
import tmpl_nds from './licensingAndPermittingPublicComplaintEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensingAndPermittingPublicComplaintEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

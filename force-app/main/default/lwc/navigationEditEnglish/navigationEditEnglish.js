...
import { OMNIDEF } from './navigationEditEnglish_def.js';
import tmpl from './navigationEditEnglish.html';
import tmpl_nds from './navigationEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class navigationEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

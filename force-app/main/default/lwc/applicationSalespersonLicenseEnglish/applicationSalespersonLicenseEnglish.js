...
import { OMNIDEF } from './applicationSalespersonLicenseEnglish_def.js';
import tmpl from './applicationSalespersonLicenseEnglish.html';
import tmpl_nds from './applicationSalespersonLicenseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationSalespersonLicenseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

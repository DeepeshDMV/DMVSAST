...
import { OMNIDEF } from './sPApplicationDocumentGeneratorEnglish_def.js';
import tmpl from './sPApplicationDocumentGeneratorEnglish.html';
import tmpl_nds from './sPApplicationDocumentGeneratorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPApplicationDocumentGeneratorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

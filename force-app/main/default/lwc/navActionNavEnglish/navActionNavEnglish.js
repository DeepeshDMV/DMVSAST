...
import { OMNIDEF } from './navActionNavEnglish_def.js';
import tmpl from './navActionNavEnglish.html';
import tmpl_nds from './navActionNavEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class navActionNavEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

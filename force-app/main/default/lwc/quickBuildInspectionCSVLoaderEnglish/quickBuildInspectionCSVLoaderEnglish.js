...
import { OMNIDEF } from './quickBuildInspectionCSVLoaderEnglish_def.js';
import tmpl from './quickBuildInspectionCSVLoaderEnglish.html';
import tmpl_nds from './quickBuildInspectionCSVLoaderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quickBuildInspectionCSVLoaderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './licensingAndPermittingComplaintEnglish_def.js';
import tmpl from './licensingAndPermittingComplaintEnglish.html';
import tmpl_nds from './licensingAndPermittingComplaintEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensingAndPermittingComplaintEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './licensingAndPermittingApplicationSubmissionEnglish_def.js';
import tmpl from './licensingAndPermittingApplicationSubmissionEnglish.html';
import tmpl_nds from './licensingAndPermittingApplicationSubmissionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensingAndPermittingApplicationSubmissionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

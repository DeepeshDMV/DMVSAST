...
import { OMNIDEF } from './businessLicenseApplicationSalesPersonApplicationInformationEnglish_def.js';
import tmpl from './businessLicenseApplicationSalesPersonApplicationInformationEnglish.html';
import tmpl_nds from './businessLicenseApplicationSalesPersonApplicationInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationSalesPersonApplicationInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './licensingAndPermittingLPSearchEnglish_def.js';
import tmpl from './licensingAndPermittingLPSearchEnglish.html';
import tmpl_nds from './licensingAndPermittingLPSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensingAndPermittingLPSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

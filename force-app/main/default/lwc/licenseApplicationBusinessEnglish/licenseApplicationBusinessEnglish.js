...
import { OMNIDEF } from './licenseApplicationBusinessEnglish_def.js';
import tmpl from './licenseApplicationBusinessEnglish.html';
import tmpl_nds from './licenseApplicationBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licenseApplicationBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfSalesPersonFees_1_CADMV extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfSalesPersonFees_1_CADMV';
              @track record;

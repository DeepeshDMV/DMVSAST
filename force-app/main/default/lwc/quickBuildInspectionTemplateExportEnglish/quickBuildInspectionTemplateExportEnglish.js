...
import { OMNIDEF } from './quickBuildInspectionTemplateExportEnglish_def.js';
import tmpl from './quickBuildInspectionTemplateExportEnglish.html';
import tmpl_nds from './quickBuildInspectionTemplateExportEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quickBuildInspectionTemplateExportEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

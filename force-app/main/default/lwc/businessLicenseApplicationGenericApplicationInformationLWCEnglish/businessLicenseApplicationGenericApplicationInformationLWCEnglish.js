...
import { OMNIDEF } from './businessLicenseApplicationGenericApplicationInformationLWCEnglish_def.js';
import tmpl from './businessLicenseApplicationGenericApplicationInformationLWCEnglish.html';
import tmpl_nds from './businessLicenseApplicationGenericApplicationInformationLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationGenericApplicationInformationLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

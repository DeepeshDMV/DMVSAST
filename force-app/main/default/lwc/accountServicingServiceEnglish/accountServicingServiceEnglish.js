...
import { OMNIDEF } from './accountServicingServiceEnglish_def.js';
import tmpl from './accountServicingServiceEnglish.html';
import tmpl_nds from './accountServicingServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountServicingServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

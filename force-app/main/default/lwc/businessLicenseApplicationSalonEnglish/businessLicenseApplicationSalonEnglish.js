...
import { OMNIDEF } from './businessLicenseApplicationSalonEnglish_def.js';
import tmpl from './businessLicenseApplicationSalonEnglish.html';
import tmpl_nds from './businessLicenseApplicationSalonEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationSalonEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

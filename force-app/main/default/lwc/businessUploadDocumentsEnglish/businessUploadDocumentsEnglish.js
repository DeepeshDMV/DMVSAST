...
import { OMNIDEF } from './businessUploadDocumentsEnglish_def.js';
import tmpl from './businessUploadDocumentsEnglish.html';
import tmpl_nds from './businessUploadDocumentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessUploadDocumentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

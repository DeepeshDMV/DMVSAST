...
import { OMNIDEF } from './reviewAndSubmitFeeReviewEnglish_def.js';
import tmpl from './reviewAndSubmitFeeReviewEnglish.html';
import tmpl_nds from './reviewAndSubmitFeeReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class reviewAndSubmitFeeReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

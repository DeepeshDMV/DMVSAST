...
import { OMNIDEF } from './inspectionsandComplaintsBusinessLicenseApplicationEnglish_def.js';
import tmpl from './inspectionsandComplaintsBusinessLicenseApplicationEnglish.html';
import tmpl_nds from './inspectionsandComplaintsBusinessLicenseApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inspectionsandComplaintsBusinessLicenseApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './quickBuildInspectionTemplateImportEnglish_def.js';
import tmpl from './quickBuildInspectionTemplateImportEnglish.html';
import tmpl_nds from './quickBuildInspectionTemplateImportEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quickBuildInspectionTemplateImportEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

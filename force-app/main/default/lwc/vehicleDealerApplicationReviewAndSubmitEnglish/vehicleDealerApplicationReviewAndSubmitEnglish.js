...
import { OMNIDEF } from './vehicleDealerApplicationReviewAndSubmitEnglish_def.js';
import tmpl from './vehicleDealerApplicationReviewAndSubmitEnglish.html';
import tmpl_nds from './vehicleDealerApplicationReviewAndSubmitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vehicleDealerApplicationReviewAndSubmitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

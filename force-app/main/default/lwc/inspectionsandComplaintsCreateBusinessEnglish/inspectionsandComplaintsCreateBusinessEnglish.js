...
import { OMNIDEF } from './inspectionsandComplaintsCreateBusinessEnglish_def.js';
import tmpl from './inspectionsandComplaintsCreateBusinessEnglish.html';
import tmpl_nds from './inspectionsandComplaintsCreateBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inspectionsandComplaintsCreateBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

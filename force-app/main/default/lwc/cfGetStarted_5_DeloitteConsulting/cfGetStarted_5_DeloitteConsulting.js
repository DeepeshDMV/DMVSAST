import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfGetStarted_5_DeloitteConsulting extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfGetStarted_5_DeloitteConsulting';
              @track record;
              ...
              registerPubSub() {
                pubsub.register('GetStarted', {
                          getlateststatus: this.handleEventAction.bind(this, data.events[0],0)
                      });

...
import { OMNIDEF } from './vehicleDealerApplicationEditReviewAndSubmitEnglish_def.js';
import tmpl from './vehicleDealerApplicationEditReviewAndSubmitEnglish.html';
import tmpl_nds from './vehicleDealerApplicationEditReviewAndSubmitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vehicleDealerApplicationEditReviewAndSubmitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

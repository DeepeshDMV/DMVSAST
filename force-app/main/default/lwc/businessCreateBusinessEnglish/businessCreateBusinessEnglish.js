...
import { OMNIDEF } from './businessCreateBusinessEnglish_def.js';
import tmpl from './businessCreateBusinessEnglish.html';
import tmpl_nds from './businessCreateBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessCreateBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

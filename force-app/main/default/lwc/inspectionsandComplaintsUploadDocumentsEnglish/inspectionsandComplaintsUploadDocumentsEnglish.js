...
import { OMNIDEF } from './inspectionsandComplaintsUploadDocumentsEnglish_def.js';
import tmpl from './inspectionsandComplaintsUploadDocumentsEnglish.html';
import tmpl_nds from './inspectionsandComplaintsUploadDocumentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inspectionsandComplaintsUploadDocumentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

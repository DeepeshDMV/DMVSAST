...
import { OMNIDEF } from './complaintsPublicComplaintEnglish_def.js';
import tmpl from './complaintsPublicComplaintEnglish.html';
import tmpl_nds from './complaintsPublicComplaintEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class complaintsPublicComplaintEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

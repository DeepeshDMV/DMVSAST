...
import { OMNIDEF } from './inspectionsandComplaintsTestEnglish_def.js';
import tmpl from './inspectionsandComplaintsTestEnglish.html';
import tmpl_nds from './inspectionsandComplaintsTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inspectionsandComplaintsTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './businessLicenseApplicationLWCGenaricLWCEnglish_def.js';
import tmpl from './businessLicenseApplicationLWCGenaricLWCEnglish.html';
import tmpl_nds from './businessLicenseApplicationLWCGenaricLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class businessLicenseApplicationLWCGenaricLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

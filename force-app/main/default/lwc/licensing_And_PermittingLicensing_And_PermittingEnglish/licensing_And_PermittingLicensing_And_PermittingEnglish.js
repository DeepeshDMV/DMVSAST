...
import { OMNIDEF } from './licensing_And_PermittingLicensing_And_PermittingEnglish_def.js';
import tmpl from './licensing_And_PermittingLicensing_And_PermittingEnglish.html';
import tmpl_nds from './licensing_And_PermittingLicensing_And_PermittingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensing_And_PermittingLicensing_And_PermittingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

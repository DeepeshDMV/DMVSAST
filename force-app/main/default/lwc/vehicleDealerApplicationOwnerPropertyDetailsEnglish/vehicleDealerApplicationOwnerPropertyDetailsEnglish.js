...
import { OMNIDEF } from './vehicleDealerApplicationOwnerPropertyDetailsEnglish_def.js';
import tmpl from './vehicleDealerApplicationOwnerPropertyDetailsEnglish.html';
import tmpl_nds from './vehicleDealerApplicationOwnerPropertyDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vehicleDealerApplicationOwnerPropertyDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

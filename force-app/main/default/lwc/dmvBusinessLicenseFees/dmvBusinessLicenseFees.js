...
const columns2 = [
  { label: "Fee Parent", fieldName: "Name" },
  { label: "Fee Number", fieldName: "CreatedDate", type: "date" },
  { label: "Amount", fieldName: "CreatedByName" },
  { label: "Total Checkout Amount", fieldName: "Status" },
];

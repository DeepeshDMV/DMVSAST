...
import { OMNIDEF } from './applicationSalespersonLicenseSubmitAndReviewEnglish_def.js';
import tmpl from './applicationSalespersonLicenseSubmitAndReviewEnglish.html';
import tmpl_nds from './applicationSalespersonLicenseSubmitAndReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationSalespersonLicenseSubmitAndReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
